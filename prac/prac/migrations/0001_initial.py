    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, verbose_name='ID', auto_created=True, serialize=False)),
                ('uid', models.CharField(max_length=10)),
                ('zoom', models.CharField(default='country', max_length=7, choices=[('region', 'region'), ('country', 'country'), ('county', 'county'), ('edist', 'edist')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('b01_05', models.IntegerField()),
                ('g06', models.IntegerField()),
                ('age_ns', models.IntegerField()),
                ('age_total_hh', models.IntegerField()),
                ...
                ('oc_ns', models.IntegerField()),
                ('oc_total_hh', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ge_eigh_phh', models.IntegerField()),
                ('total_hh', models.IntegerField()),
            ],
        ),
        migrations.CreateModel(
            name='Sale',
            fields=[
                ...
                ('county', models.CharField(default='Dublin', max_length=9, choices=[('Galway', 'Galway'), ('Leitrim', 'Leitrim'), ('Mayo', 'Mayo'), ('Roscommon', 'Roscommon'), ('Sligo', 'Sligo'), ('Carlow', 'Carlow'), ('Dublin', 'Dublin'), ('Kildare', 'Kildare'), ('Kilkenny', 'Kilkenny'), ('Laois', 'Laois'), ('Longford', 'Longford'), ('Louth', 'Louth'), ('Meath', 'Meath'), ('Offaly', 'Offaly'), ('Westmeath', 'Westmeath'), ('Wexford', 'Wexford'), ('Wicklow', 'Wicklow'), ('Clare', 'Clare'), ('Cork', 'Cork'), ('Kerry', 'Kerry'), ('Limerick', 'Limerick'), ('Tipperary', 'Tipperary'), ('Waterford', 'Waterford'), ('Cavan', 'Cavan'), ('Donegal', 'Donegal'), ('Monaghan', 'Monaghan')])),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('nfma', models.CharField(default='no', max_length=3, choices=[('yes', 'yes'), ('no', 'no')])),
                ('vat_ex', models.CharField(default='no', max_length=3, choices=[('yes', 'yes'), ('no', 'no')])),
                ('DoP', models.CharField(default='Second-Hand Dwelling house /Apartment', max_length=40, choices=[('Second-Hand Dwelling house /Apartment', 'Second-Hand'), ('New Dwelling house /Apartment', 'New')])),
                ('PSD', models.CharField(default='Unknown', max_length=70, choices=[('Second-Hand Dwelling house /Apartment', 'Second-Hand'), ('New Dwelling house /Apartment', 'New')])),
                ('region', models.CharField(default='Leinster', max_length=8, choices=[('Connacht', 'Connacht'), ('Leinster', 'Leinster'), ('Munster', 'Munster'), ('Ulster', 'Ulster')])),
