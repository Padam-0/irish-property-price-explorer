...
def main():
    ...
    df_pr.GEOGTYPE = df_pr.GEOGTYPE.replace(['CTY', 'ED', 'SA', 'PR', 'IRL'],
                            ['county', 'edist', 'area', 'region', 'country'])
    ...
    df_cty.GEOGTYPE = df_cty.GEOGTYPE.replace(['CTY', 'ED', 'SA', 'PR', 'IRL'],
                          ['county', 'edist', 'area', 'region', 'country'])
    ...
    df_cty = pd.concat([df_cty, df_dub, df_cork, df_lim, df_tip, df_wat, df_gal], ignore_index=True)
    df_cty = df_cty.drop([1, 2, 3, 4, 16, 17, 19, 20, 21, 22, 23, 24, 25, 26], axis='rows').sort_values(by='GEOGID')
    ...
    for i in range(len(df_list)):
        ...
        cso_ref = df.drop([i for i in df.columns if i not in cso_ref_names], axis='columns')
   ...
   'T1_1AGE30_34T', 'T1_1AGE35_39T', 'T1_1AGE40_44T']
        ...
        et1 = et1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T1_1AGE0_4M', 'T1_1AGE5_9M', 'T1_1AGE10_14M',
        ...
        t1_1 = t1_1.drop([i for i in t1_1.columns if
                          (i.count('_') == 1 and i[0] != 'G' and i[-2] != 'T')],
                         axis='columns')

        t1_1['year'] = 2011

        t1_1 = t1_1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T1_1AGE0_4T', 'T1_1AGE5_9T',
        ...
        t2_1 = t2_1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T2_1IEBP', 'T2_1UKBP',
                'T2_1PLBP', 'T2_1LTBP',
                'T2_1EUBP', 'T2_1RWBP', 'T2_1NSBP', 'T2_1TBP', 'T2_1IEN',
                'T2_1UKN',
                'T2_1PLN', 'T2_1LTN', 'T2_1EUN', 'T2_1RWN', 'T2_1NSN',
                'T2_1TN']]
        ...
        t4_2 = t4_2.ix[:, ['GEOGID', 'GEOGTYPE', 'year', 'T4_2_NCT', 'T4_2_1CT',
                'T4_2_2CT', 'T4_2_3CT',
                'T4_2_4CT', 'T4_2_GE5T']]


        t4_5 = t4_5.drop(
            [i for i in t4_5.columns if (i[-1] != 'P' and i[0] != 'G')],
            axis='columns')
        ...
        t5_1 = t5_1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T5_1OP_H', 'T5_1HW_H',
                'T5_1CC_H', 'T5_1HWC_H',
                'T5_1CCC_H', 'T5_1FC_H', 'T5_1MC_H', 'T5_1CO_H', 'T5_1CCO_H',
                'T5_1FCO_H', 'T5_1MCO_H', 'T5_1GETFU_H', 'T5_1NHR_H',
                'T5_1GENP_H',
                'T5_1T_H']]
        ...
        t6_1 = t6_1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T6_1_HB_H', 'T6_1_FA_H',
                'T6_1_BS_H',
                'T6_1_CM_H', 'T6_1_NS_H', 'T6_1_TH']]

        t6_2['T6_2_01_10H'] = round((t6_2['T6_2_01_05H'] + t6_2['T6_2_06LH']) * 10/21,0)
        t6_2['T6_2_11LH'] = round((t6_2['T6_2_01_05H'] + t6_2['T6_2_06LH']) * 1/21,0)
        ...
        t6_8 = t6_8.ix[:,
               ['GEOGID', 'GEOGTYPE', 'T6_8_O', 'temp_unoc', 'unoc_hol',
                'T6_8_U']]
        ...
        t8_1['year'] = 2011
        t8_1 = t8_1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T8_1_WT', 'T8_1_LFFJT',
                'T8_1_ULGUPJT',
        ...
        t9_1['year'] = 2011
        t9_1 = t9_1.ix[:,
               ['GEOGID', 'GEOGTYPE', 'year', 'T9_1_PWT', 'T9_1_MTT',
                'T9_1_NMT', 'T9_1_ST',
        ...
        t10_4['year'] = 2011
        t10_4 = t10_4.ix[:,
                ['GEOGID', 'GEOGTYPE', 'year', 'T10_4_NFT', 'T10_4_PT',
                 'T10_4_LST', 'T10_4_UST',
        ...
        t11_1['year'] = 2011
        t11_1 = t11_1.ix[:,
                ['GEOGID', 'GEOGTYPE', 'year', 'T11_1_F', 'T11_1_BI',
                 'T11_1_BU', 'T11_1_TDL',
                 'T11_1_M', 'T11_1_CD', 'T11_1_CP', 'T11_1_V', 'T11_1_OTH',
                 'T11_1_NS',
                 'T11_1_T']]
        ...
        t13_1 = t13_1.ix[:,
                ['GEOGID', 'GEOGTYPE', 'year', 'T13_1_MDSOT', 'T13_1_POT',
                 'T13_1_APTOT',
                 'T13_1_ASOT', 'T13_1_STOT', 'T13_1_CLOSOT', 'T13_1_SCSOT',
        ...
        t14_1['year'] = 2011
        t14_1 = t14_1.ix[:,
                ['GEOGID', 'GEOGTYPE', 'year', 'T14_1_AFFT', 'T14_1_BCT',
                 'T14_1_MIT',
                 'T14_1_CTT', 'T14_1_TCT', 'T14_1_PAT', 'T14_1_PST',
                 'T14_1_OTHT',
                 'T14_1_TT']]
