...
#
# for j in range(1,4):
#     print(">" + str(1 + 0.1 * j) + " std above mean: ", len([i for i in princes if i > np.mean(princes) + np.std(princes) * (1 + 0.1 * j)]))
# for j in range(1, 4):
#     print(">" + str(1 + 0.1 * j) + " std below mean: ", len([i for i in princes if i < np.mean(princes) + np.std(princes) * -(1 + 0.1 * j)]))
...
# for j in range(1,4):
#     print(">" + str(j) + " std above mean: ", len([i for i in jobs if i > np.mean(jobs) + np.std(jobs) * j]))
# for j in range(1, 4):
#     print(">" + str(j) + " std below mean: ", len([i for i in jobs if i < np.mean(jobs) + np.std(jobs) * -j]))
...
# print(sorted(enest_dif, reverse=True)) # 'E27030' Errislannan, R341, Shannanagower, Co. Galway
...
# for j in range(1,4):
#     print(">" + str(j) + " std above mean: ", len([i for i in enest_dif if i > np.std(enest_dif) * 1.6]))
# for j in range(1, 4):
#     print(">" + str(j) + " std below mean: ", len([i for i in enest_dif if i < np.std(enest_dif) * -0.85]))
...
# for j in range(1,4):
#     print(">" + str(j) + " std aboce mean: ", len([i for i in ret_dif if i > np.std(ret_dif) * j]))
# for j in range(1, 4):
#     print(">" + str(j) + " std below mean: ", len([i for i in ret_dif if i < np.std(ret_dif) * -j]))
