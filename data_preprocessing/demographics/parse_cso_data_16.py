...
def main():
    ...
    df_cty = pd.read_csv('data/2016/SAPS2016_CTY31.csv', thousands=',',
                         encoding='latin1')
    ...
    df_cty = df_cty.drop([0, 2, 5, 7, 8, 9, 10, 24],
                         axis='rows').sort_values(by='desc')
    ...
    df_ed = pd.read_csv('data/2016/SAPS2016_ED3409.csv', thousands=',',
                        encoding='latin1')
    ...
    for i in range(len(df_list)):
        ...
        # Population aged 0-19 by sex and year of age, persons aged 20+
        ...
        t11_1 = df.drop([i for i in df.columns if i not in table_11_1],
                        axis='columns')
        # Population aged 5 years and over by journey time to work, school
        # or college
        ...
        et1 = et1.ix[:, ['uid', 'zoom', 'year', 'T1_1AGE0_4M', 'T1_1AGE5_9M',
                         'T1_1AGE10_14M', 'T1_1AGE15_19M', 'T1_1AGE20_24M',
                         'T1_1AGE25_29M', 'T1_1AGE30_34M', 'T1_1AGE35_39M',
                         'T1_1AGE40_44M', 'T1_1AGE45_49M',  'T1_1AGE50_54M',
                         'T1_1AGE55_59M', 'T1_1AGE60_64M', 'T1_1AGE65_69M',
                         'T1_1AGE70_74M', 'T1_1AGE75_79M', 'T1_1AGE80_84M',
                         'T1_1AGEGE_85M',  'T1_1AGE0_4F', 'T1_1AGE5_9F',
                         'T1_1AGE10_14F',  'T1_1AGE15_19F',  'T1_1AGE20_24F',
                         'T1_1AGE25_29F', 'T1_1AGE30_34F', 'T1_1AGE35_39F',
                         'T1_1AGE40_44F', 'T1_1AGE45_49F', 'T1_1AGE50_54F',
                         'T1_1AGE55_59F', 'T1_1AGE60_64F', 'T1_1AGE65_69F',
                         'T1_1AGE70_74F', 'T1_1AGE75_79F', 'T1_1AGE80_84F',
                         'T1_1AGEGE_85F', 'T1_1AGE0T', 'T1_1AGE1T',
                         'T1_1AGE2T', 'T1_1AGE3T', 'T1_1AGE4T', 'T1_1AGE5T',
                         'T1_1AGE6T', 'T1_1AGE7T', 'T1_1AGE8T', 'T1_1AGE9T',
        ...
        t1_1 = t1_1.drop(
            [i for i in t1_1.columns if (i[-1] != 'T' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        ...
        t1_1['T1_1AGE10_14T'] = t1_1['T1_1AGE10T'] + t1_1['T1_1AGE11T'] + \
            t1_1['T1_1AGE12T'] + t1_1['T1_1AGE13T'] + \
            t1_1['T1_1AGE14T']
        t1_1['T1_1AGE15_19T'] = t1_1['T1_1AGE15T'] + t1_1['T1_1AGE16T'] + \
            t1_1['T1_1AGE17T'] + t1_1['T1_1AGE18T'] + \
            t1_1['T1_1AGE19T']

        t1_1 = t1_1.drop([i for i in t1_1.columns if
                          (i.count('_') == 1 and i not in
                           ['uid', 'zoom', 'year'] and i[-2] != 'T')
                          ], axis='columns')
        ...
        t1_2 = t1_2.drop(
            [i for i in t1_2.columns if (i[-1] != 'T' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')

        t1_2 = t1_2.ix[:, ['uid', 'zoom', 'year', 'T1_2SGLT', 'T1_2MART',
                           'T1_2SEPT', 'T1_2DIVT', 'T1_2WIDT', 'T1_2T']]

        t1_2.columns = ['uid', 'zoom', 'year', 'single', 'married',
                        'separated', 'divorced', 'widowed', 'mar_total']

        t1 = t1_1.join(t1_2, rsuffix='test')
        t1 = t1.drop([i for i in t1.columns if i[-4:] == 'test'],
                     axis='columns')

        t2_1 = t2_1.ix[:, ['uid', 'zoom', 'year', 'T2_1IEBP', 'T2_1UKBP',
                           'T2_1PLBP', 'T2_1LTBP', 'T2_1EUBP', 'T2_1RWBP',
                           'T2_1NSBP', 'T2_1TBP', 'T2_1IEN', 'T2_1UKN',
                           'T2_1PLN', 'T2_1LTN', 'T2_1EUN', 'T2_1RWN',
                           'T2_1NSN', 'T2_1TN']]
        ...
        t4_2 = t4_2.drop(
            [i for i in t4_2.columns if (i[-1] != 'T' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        t4_2 = t4_2.ix[:, ['uid', 'zoom', 'year', 'T4_2_NCT', 'T4_2_1CT',
                           'T4_2_2CT', 'T4_2_3CT', 'T4_2_4CT', 'T4_2_GE5CT']]

        t4_5 = t4_5.drop(
            [i for i in t4_5.columns if (i[-1] != 'P' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        t4_5 = t4_5.ix[:, ['uid', 'zoom', 'year', 'T4_5PFP', 'T4_5ENP',
                           'T4_5RP', 'T4_5PSP', 'T4_5ESP', 'T4_5PAP',
        ...
        t5_1 = t5_1.drop(
            [i for i in t5_1.columns if (i[-1] != 'H' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        t5_1 = t5_1.ix[:, ['uid', 'zoom', 'year', 'T5_1OP_H', 'T5_1MC_H',
                           'T5_1CC_H', 'T5_1MCC_H', 'T5_1CCC_H', 'T5_1OPFC_H',
                           'T5_1OPMC_H', 'T5_1CO_H', 'T5_1CCO_H',
                           'T5_1OPFCO_H', 'T5_1OPMCO_H', 'T5_1GETFU_H',
                           'T5_1NHR_H', 'T5_1GENP_H', 'T5_1T_H']]

        t5_2 = t5_2.drop(
            [i for i in t5_2.columns if (i[-1] != 'H' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        ...
        t6_1 = t6_1.drop(
            [i for i in t6_1.columns if (i[-1] != 'H' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')

        t6_1 = t6_1.ix[:, ['uid', 'zoom', 'year', 'T6_1_HB_H', 'T6_1_FA_H',
                           'T6_1_BS_H', 'T6_1_CM_H', 'T6_1_NS_H', 'T6_1_TH']]

        t6_2 = t6_2.drop([i for i in t6_2.columns if
                          (i[-1] != 'H' and i not in ['uid', 'zoom', 'year'])
                          ], axis='columns')

        t6_2 = t6_2.ix[:, ['uid', 'zoom', 'year', 'T6_2_PRE19H',
                           'T6_2_19_45H', 'T6_2_46_60H', 'T6_2_61_70H',
                           'T6_2_71_80H', 'T6_2_81_90H', 'T6_2_91_00H',
                           'T6_2_01_10H', 'T6_2_11LH', 'T6_2_NSH', 'T6_2_TH']]

        t6_3 = t6_3.drop(
            [i for i in t6_3.columns if (i[-1] != 'H' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        t6_4 = t6_4.drop(
            [i for i in t6_4.columns if (i[-1] != 'H' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        t6_8 = t6_8.drop(
            [i for i in t6_8.columns if (i[-1] == 'T' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')
        ...
        t6.columns = ['uid', 'zoom', 'year', 'house_bung', 'apart', 'bedsit',
                      ...
                      'rooms_7', 'rooms_ge8', 'rooms_ns', 'rooms_total_hh',
                      'occupied', 'temp_unoc', 'unoc_hol', 'unoccupied']

        t8_1 = t8_1.drop(
            [i for i in t8_1.columns if (i[-1] != 'T' and i not in
                                         ['uid', 'zoom', 'year'])],
            axis='columns')

        t8_1 = t8_1.ix[:, ['uid', 'zoom', 'year', 'T8_1_WT', 'T8_1_LFFJT',
                           'T8_1_ULGUPJT', 'T8_1_ST', 'T8_1_LAHFT', 'T8_1_RT',
                           'T8_1_UTWSDT', 'T8_1_OTHT', 'T8_1_TT']]
        ...
        t9_1 = t9_1.drop([i for i in t9_1.columns if
                          (i[-1] != 'T' and i not in ['uid', 'zoom', 'year'])
                          ], axis='columns')

        t9_1 = t9_1.ix[:, ['uid', 'zoom', 'year', 'T9_1_PWT', 'T9_1_MTT',
                           'T9_1_NMT', 'T9_1_ST', 'T9_1_SST', 'T9_1_UST',
                           'T9_1_OTHGEUT', 'T9_1_TT']]
        ...
        t10_4 = t10_4.drop(
            [i for i in t10_4.columns if (i[-1] != 'T' and i not in
                                          ['uid', 'zoom', 'year'])],
            axis='columns')

        t10_4 = t10_4.ix[:, ['uid', 'zoom', 'year', 'T10_4_NFT', 'T10_4_PT',
                             'T10_4_LST', 'T10_4_UST', 'T10_4_TVT',
                             'T10_4_ACCAT', 'T10_4_HCT', 'T10_4_ODNDT',
        ...
        t11_1 = t11_1.ix[:, ['uid', 'zoom', 'year', 'T11_1_FT', 'T11_1_BIT',
                             'T11_1_BUT', 'T11_1_TDLT', 'T11_1_MT',
                             'T11_1_CDT', 'T11_1_CPT', 'T11_1_VT',
                             'T11_1_OTHT', 'T11_1_NST', 'T11_1_TT']]
        ...
        t13_1 = t13_1.drop(
            [i for i in t13_1.columns if (i[-1] != 'T' and i not in
                                          ['uid', 'zoom', 'year'])],
            axis='columns')

        t13_1 = t13_1.ix[:, ['uid', 'zoom', 'year', 'T13_1_MDSOT',
                             'T13_1_POT', 'T13_1_APTOT',
        ...
        t14_1 = t14_1.drop(
            [i for i in t14_1.columns if (i[-1] != 'T' and i not in
                                          ['uid', 'zoom', 'year'])],
            axis='columns')

        t14_1 = t14_1.ix[:, ['uid', 'zoom', 'year', 'T14_1_AFFT', 'T14_1_BCT',
                             'T14_1_MIT', 'T14_1_CTT', 'T14_1_TCT',
                             'T14_1_PAT', 'T14_1_PST', 'T14_1_OTHT',
                             'T14_1_TT']]

        t14_1.columns = ['uid', 'zoom', 'year', 'ag_for_fish',
                         'build_construct', 'manufac', 'comm_trade',
                         'trans_coms', 'pub_admin', 'prof_ser',
                         'ind_other', 'ind_total']
        ...
        if i == 2:
            ...
            for i in t1.index:
                ...
                if '/' in t1.loc[i, 'uid']:
                    ...
                    tt10_4.append(['E' + ed_uid_2, 'edist'] +
                                  list(it10_4[2:]))
                    tt11.append(['E' + ed_uid_2, 'edist'] + list(it11[2:]))
                    tt13_1.append(['E' + ed_uid_2, 'edist'] +
                                  list(it13_1[2:]))
                    tt14_1.append(['E' + ed_uid_2, 'edist'] +
                                  list(it14_1[2:]))
